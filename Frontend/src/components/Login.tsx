...
const Login: React.FC<LoginProps> = ({ onSuccess }) => {
  ...
  const sendOTP = async () => {
    ...
    try {
      const res = await fetch('https://landsdevelop25.onrender.com/api/send-otp', {
        method: 'POST',
  ...
  const verifyOTP = async () => {
    ...
    try {
      const res = await fetch('https://landsdevelop25.onrender.com/api/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const completeSignup = async () => {
    ...
    try {
      const res = await fetch('https://landsdevelop25.onrender.com/api/complete-signup', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          phone, 
